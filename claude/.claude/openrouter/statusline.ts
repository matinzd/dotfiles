 ...
 * @see https://github.com/OpenRouterTeam/openrouter-examples
 */
  ...
  try {
    ...
    return {
      ...
      total_cache_discount:
        typeof parsed.total_cache_discount === "number"
          ? parsed.total_cache_discount
          : 0,
      last_provider:
        typeof parsed.last_provider === "string" ? parsed.last_provider : "",
      last_model:
        typeof parsed.last_model === "string" ? parsed.last_model : "",
    };
  } catch {
    return defaultState;
  }
